...
def compute_eye_diameters(mask_eye, spacing=(1.0, 1.0)):
    """
    Measure horizontal and vertical diameters of the eye from binary mask.
    spacing = (dy, dx) in physical units (µm) per pixel.
    Returns {'eye_width_um': float, 'eye_height_um': float}.
    """
